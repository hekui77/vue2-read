...
export default class Watcher {
  ...
  constructor (
    ...
    if (typeof expOrFn === 'function') {
      ...
      // this.getter = function() { return this.xxx }
      // 在 this.get 中执行 this.getter 时会触发依赖收集
      // 待后续 this.xxx 更新时就会触发响应式
  ...
  /* 
    ...
    this.getter 是实例化 watcher 时传递的第二个参数，一个函数或者一个字符串，比如：updateComponent 或者 parsePath 返回的读取 this.xx 属性值的函数
    为什么要重新收集依赖？
